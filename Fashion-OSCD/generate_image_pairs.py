...
def gen_siamese_data(support_img_class_path='./support_img_class.pickle', query_img_class_path='./query_img_class.pickle'):
    ...
    # 7 classes are randomly selected as seen classes for training/validation, the other 3 unseen classes for test.
    train_class_names = ['tshirt', 'sneaker', 'sandal', 'bag', 'coat', 'shirt', 'trouser']
    test_class_names = ['ankle_boot', 'dress', 'pullover']

    # the number of the selected image pairs for each class
    # for example, the number of training image pairs: 6000* 7 = 42,000
    num_per_class = 6000
    train_pairs = []
...
if __name__ == '__main__':
    print('Start job...')
    xml_path = 'path to Fashion OSCD dataset/train/xmls'
